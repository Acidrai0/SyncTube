...
class YouTubePlayerSeekBar(context: Context, attrs: AttributeSet? = null): LinearLayout(context, attrs), SeekBar.OnSeekBarChangeListener, YouTubePlayerListener {
    ...
    override fun onStartTrackingTouch(seekBar: SeekBar) {
        ...
        youtubePlayerSeekBarListener?.isSeeking(seekBarTouchStarted)
    ...
    override fun onStopTrackingTouch(seekBar: SeekBar) {
        ...
        Log.e("betterseconds", seekBar.progress.toString())
        youtubePlayerSeekBarListener?.seekedProgress(seekBar.progress.toString())
    }
...
interface YouTubePlayerSeekBarListener {
    ...
    fun isSeeking(seeking: Boolean)
    fun seekedProgress(seek: String)
}